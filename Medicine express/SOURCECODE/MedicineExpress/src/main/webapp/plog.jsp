...
<div class="doctor-app-plg1">
<div class="row">
<div class="col-md-4"></div>
<div class="col-md-4"><br><br><br>
	<div class="card mt-5 p-3">
		<form action="plog1.jsp" method="post">
		<div class="text-center h3">Patient Login</div>
			<div class="mb-3 mt-3">
			...
			<br>
			<div class="text-center"><a href="preg.jsp">New Patient Click Here to Register</a></div>
		</form>
	</div>
</div>
<div class="col-md-4"></div>
