...
<div class="doctor-app-dlg">
<div class="row">
<div class="col-md-4"></div>
<div class="col-md-4"><br><br><br>
	<div class="card mt-5 p-3">
		<form action="dlog1.jsp" method="post">
		<div class="text-center h3">Doctor Login</div>
			<div class="mb-3 mt-3">
			...
			<br>
			<div class="text-center"><a href="dreg.jsp">New Doctor Click Here to Register</a></div>
		</form>
	</div>
</div>
<div class="col-md-4"></div>
